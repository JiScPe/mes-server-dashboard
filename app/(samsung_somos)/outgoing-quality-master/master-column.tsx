...
export const masterColumns: ColumnDef<OutgoingQualityMasterType>[] = [
  ...
  },
  {
    ...
    header: () => <div className="text-blue-600">Inspection Type Code</div>,
  },
  {
    accessorKey: "inspection_step_code",
    header: () => <div className="text-blue-600">Inspection Step Code</div>,
  },
  {
    accessorKey: "po_no",
    header: "PO No",
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-center">{row.getValue("sample_quantity")}</div>
    ),
  },
  {
