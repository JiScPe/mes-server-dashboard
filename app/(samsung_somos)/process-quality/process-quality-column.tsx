...
export const processQualityColumns: ColumnDef<ProcessQualityType>[] = [
  ...
  { accessorKey: "customer_code", header: "Customer Code" },
  {
    ...
    header: () => <div className="text-blue-600">Site Code</div>,
  },
  {
    accessorKey: "model_name",
    header: () => <div className="text-blue-600">Model Name</div>,
  },
  {
    accessorKey: "lot_no",
    header: () => <div className="text-blue-600">Lot No</div>,
  },
  {
    accessorKey: "product_date",
    header: () => <div className="text-blue-600">Product Date</div>,
  },
  ...
  { accessorKey: "po_no", header: "PO No" },
  {
    ...
    cell: ({ row }) => (
      <div className="text-center">
        {String(row.getValue("product_quantity"))}
      </div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-center">
        {String(row.getValue("defect_quantity"))}
      </div>
    ),
  },
  {
    accessorKey: "inspection_process_description",
    header: "Inspection Process",
  },
  ...
  {
    accessorKey: "defect_set_serial_number",
    header: () => <div className="text-blue-600">Defect Set SN</div>,
  },
